...
export default function SystemHealthPage() {
  ...
  const services: Service[] = [
    ...
    { name: "Frame detector", icon: ScanSearch, status: data?.yolo_model === "LOADED" ? "Loaded" : "—", tone: data?.yolo_model === "LOADED" ? "warn" : "neutral", detail: "Prototype (simulated inference)" },
